package com.zjc.websocket.web.controller;

import com.zjc.websocket.domain.WiselyMessage;
import com.zjc.websocket.domain.WiselyResponse;
...
public class WsController {
    ...
    public static final String TEST_USER_NAME = "zjc";
